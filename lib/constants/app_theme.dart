...
class AppColors {
  ...
  static const sageXlt  = Color(0xFFE8F5EE);
  ...
  static const darkBg       = Color(0xFF0D1511);
  static const darkSurface  = Color(0xFF172119);
  static const darkSurface2 = Color(0xFF1F2D23);
  static const darkSurface3 = Color(0xFF263326);
}
...
class AppThemeColors {
  ...
  Color get sageTintBg =>
      isDark ? const Color(0xFF1A2E25) : AppColors.sageXlt;
  ...
  Color get shimmerBase      => isDark ? AppColors.darkSurface2 : const Color(0xFFF0F4F2);
  Color get shimmerHighlight => isDark ? AppColors.darkSurface3 : const Color(0xFFE2EDE8);
...
class ThemeHelper {
  ...
  static BoxDecoration cardDecoration(BuildContext context, {Color? accentLeft}) =>
      BoxDecoration(
...
class AppThemeDecorations {
  ...
  BoxDecoration fieldFocused() => BoxDecoration(
        color: tc.fieldFill,
        borderRadius: BorderRadius.circular(AppDimensions.radiusMd),
        border: Border.all(color: AppColors.sage.withAlpha(130), width: 1.5),
        boxShadow: [
          BoxShadow(color: AppColors.sage.withAlpha(20), spreadRadius: 3, blurRadius: 0),
          BoxShadow(color: AppColors.sage.withAlpha(10), blurRadius: 10, offset: const Offset(0, 2)),
        ],
      );
  ...
  BoxDecoration card() => BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(AppDimensions.radiusLg),
        boxShadow: [
          BoxShadow(color: tc.shadowColor.withAlpha(26), blurRadius: 20, offset: const Offset(0, 6)),
          BoxShadow(color: tc.shadowColor.withAlpha(10), blurRadius: 4,  offset: const Offset(0, 1)),
        ],
      );
...
// ─────────────────────────────────────────────────────────────────────────────
// AppTextStyles — all const, zero breaking changes to existing screens.
// Poppins is applied globally via ThemeData so the font cascade handles it.
// ─────────────────────────────────────────────────────────────────────────────
class AppTextStyles {
  AppTextStyles._();
  ...
  static const body = TextStyle(
    ...
    color: AppColors.ink, height: 1.65, letterSpacing: 0.05,
  );
  ...
  static const fieldLabel = TextStyle(
    ...
    color: AppColors.ink3, letterSpacing: 1.0,
  );
  ...
  static const tagline = TextStyle(
    ...
    color: AppColors.terrLt, letterSpacing: 2.8,
  );
  static const liveLabel = TextStyle(
    fontSize: 9, fontWeight: FontWeight.w700,
    color: AppColors.amberLt, letterSpacing: 1.2,
  );
  ...
  static const statLabel = TextStyle(
    ...
    color: AppColors.ink3, height: 1.5, letterSpacing: 0.2,
  );
  ...
  static const link = TextStyle(
    ...
    color: AppColors.amberDk, letterSpacing: 0.1,
  );
  static const forgotLink = TextStyle(
    fontSize: 11, fontWeight: FontWeight.w500,
    color: AppColors.terr, letterSpacing: 0.1,
  );

  static TextStyle bodyThemed(BuildContext context) =>
      body.copyWith(color: AppThemeColors.of(context).textPrimary);
  static TextStyle bodySmallThemed(BuildContext context) =>
      bodySmall.copyWith(color: AppThemeColors.of(context).textSecondary);
  static TextStyle sectionHeadThemed(BuildContext context) =>
      sectionHead.copyWith(color: AppThemeColors.of(context).textPrimary);
  static TextStyle bodyMutedThemed(BuildContext context) =>
      bodyMuted.copyWith(color: AppThemeColors.of(context).textMuted);
  static TextStyle cardHeadThemed(BuildContext context) =>
      cardHead.copyWith(color: AppThemeColors.of(context).textPrimary);
}
...
class AppDimensions {
  ...
  static const cardPadding     = EdgeInsets.fromLTRB(24, 28, 24, 24);
  static const heroPadding     = EdgeInsets.fromLTRB(22, 18, 22, 26);
  static const fieldContentPad = EdgeInsets.symmetric(horizontal: 16, vertical: 15);
...
class AppAnimations {
  ...
  static const curveSnap    = Cubic(0.16, 1.0, 0.3, 1.0);
  static const curveOut     = Curves.easeOut;
  static const curveInOut   = Curves.easeInOut;
  static const curveElastic = Cubic(0.34, 1.56, 0.64, 1.0);
}
...
class AppDecorations {
  ...
  static BoxDecoration card = BoxDecoration(
    ...
    boxShadow: [
      BoxShadow(color: AppColors.ink.withAlpha(8),  blurRadius: 4,  offset: const Offset(0, 2)),
      BoxShadow(color: AppColors.ink.withAlpha(22), blurRadius: 40, offset: const Offset(0, 14)),
    ],
  );
  ...
  static BoxDecoration statsCard = BoxDecoration(
    ...
    borderRadius: BorderRadius.circular(AppDimensions.radiusLg),
    boxShadow: [
      BoxShadow(color: AppColors.ink.withAlpha(24), blurRadius: 28, offset: const Offset(0, 8)),
      BoxShadow(color: AppColors.ink.withAlpha(10), blurRadius: 6,  offset: const Offset(0, 2)),
    ],
  );
  ...
  static BoxDecoration cardAccentThemed(BuildContext context, Color accentColor) =>
      BoxDecoration(
        color: AppThemeColors.of(context).cardBg,
        borderRadius: BorderRadius.circular(AppDimensions.radiusLg),
        border: Border.all(color: accentColor.withAlpha(80)),
        boxShadow: [
          BoxShadow(color: AppThemeColors.of(context).shadowColor.withAlpha(18), blurRadius: 16, offset: const Offset(0, 4)),
          BoxShadow(color: AppThemeColors.of(context).shadowColor.withAlpha(8),  blurRadius: 4,  offset: const Offset(0, 1)),
        ],
      );
  ...
  static BoxDecoration sageBgThemed(BuildContext context) => BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(AppDimensions.radiusMd),
        border: Border.all(color: AppColors.sage.withAlpha(40)),
      );

  static BoxDecoration fieldThemed(BuildContext context) =>
      AppThemeDecorations.of(context).field();

  static BoxDecoration sagePill = BoxDecoration(
    color: AppColors.sage.withAlpha(18),
    border: Border.all(color: AppColors.sage.withAlpha(50)),
    borderRadius: BorderRadius.circular(AppDimensions.radiusPill),
  );

  static BoxDecoration terrPill = BoxDecoration(
    color: AppColors.terr.withAlpha(18),
    border: Border.all(color: AppColors.terr.withAlpha(46)),
    borderRadius: BorderRadius.circular(AppDimensions.radiusPill),
  );

  static BoxDecoration liveBadge = BoxDecoration(
    color: AppColors.amberLt.withAlpha(46),
    border: Border.all(color: AppColors.amberLt.withAlpha(80)),
    borderRadius: BorderRadius.circular(AppDimensions.radiusPill),
  );

  static BoxDecoration toggleBg = BoxDecoration(
    color: AppColors.sageBg,
    border: Border.all(color: AppColors.sage.withAlpha(35)),
  ...
  static BoxDecoration toggleActive = BoxDecoration(
    ...
    boxShadow: [
      BoxShadow(color: AppColors.sage.withAlpha(70), blurRadius: 12, offset: const Offset(0, 3)),
    ],
  );
...
class AppGradients {
  ...
  static const sageButtonVibrant = LinearGradient(
    colors: [Color(0xFF5BC494), AppColors.sage, AppColors.sageDk],
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
  );
  ...
  static const pageSplit = LinearGradient(
    ...
    colors: [
      ...
      Color(0xFFEEF7F2), Color(0xFFE8F5EE),
    ],
  );
...
// ─────────────────────────────────────────────────────────────────────────────
// AppTheme
// Poppins applied via fontFamily + textTheme — cascades to every Text widget
// in the app automatically. No other files need to change.
// ─────────────────────────────────────────────────────────────────────────────
class AppTheme {
  AppTheme._();
  ...
  static final light = ThemeData(
    ...
    textTheme: GoogleFonts.poppinsTextTheme(
      const TextTheme(
        displayLarge:   TextStyle(fontWeight: FontWeight.w700, fontSize: 36, letterSpacing: -0.5, color: AppColors.ink),
        displayMedium:  TextStyle(fontWeight: FontWeight.w700, fontSize: 30, letterSpacing: -0.4, color: AppColors.ink),
        displaySmall:   TextStyle(fontWeight: FontWeight.w600, fontSize: 24, color: AppColors.ink),
        headlineLarge:  TextStyle(fontWeight: FontWeight.w700, fontSize: 22, color: AppColors.ink),
        headlineMedium: TextStyle(fontWeight: FontWeight.w600, fontSize: 18, color: AppColors.ink),
        headlineSmall:  TextStyle(fontWeight: FontWeight.w600, fontSize: 16, color: AppColors.ink),
        ...
        bodyMedium:     TextStyle(fontWeight: FontWeight.w400, fontSize: 13, height: 1.6, color: AppColors.ink),
        bodySmall:      TextStyle(fontWeight: FontWeight.w300, fontSize: 11.5, color: AppColors.ink3),
        labelLarge:     TextStyle(fontWeight: FontWeight.w700, fontSize: 12.5, letterSpacing: 0.3),
        labelMedium:    TextStyle(fontWeight: FontWeight.w600, fontSize: 11,   letterSpacing: 0.2),
        labelSmall:     TextStyle(fontWeight: FontWeight.w600, fontSize: 9.5,  letterSpacing: 0.5),
      ),
    ),
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        ...
        foregroundColor: Colors.white,
        shadowColor: AppColors.sage.withAlpha(100),
        elevation: 4,
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(AppDimensions.radiusMd),
        borderSide:
            BorderSide(color: AppColors.sage.withAlpha(130), width: 1.5),
      ),
    ...
    chipTheme: ChipThemeData(
      ...
      side: BorderSide(color: AppColors.sageLt.withAlpha(120)),
      shape:
    ...
    dividerTheme: DividerThemeData(
      color: AppColors.ink.withAlpha(18), thickness: 1, space: 1,
    ),
    switchTheme: SwitchThemeData(
      thumbColor: WidgetStateProperty.resolveWith((s) =>
          s.contains(WidgetState.selected) ? AppColors.sage : Colors.white),
      trackColor: WidgetStateProperty.resolveWith((s) =>
          s.contains(WidgetState.selected)
              ? AppColors.sage.withAlpha(100)
  ...
  static final dark = ThemeData(
    ...
    colorScheme: const ColorScheme(
      ...
      surface: Color(0xFF172119),
      onSurface: Color(0xFFE8EFF0),
      surfaceContainerHighest: Color(0xFF1F2D23),
      ...
      onInverseSurface: Color(0xFF0D1511),
      inversePrimary: AppColors.sage,
    ),
    fontFamily: GoogleFonts.poppins().fontFamily,
    textTheme: GoogleFonts.poppinsTextTheme(
      const TextTheme(
        displayLarge:   TextStyle(fontWeight: FontWeight.w700, fontSize: 36, letterSpacing: -0.5, color: Color(0xFFE8EFF0)),
        displayMedium:  TextStyle(fontWeight: FontWeight.w700, fontSize: 30, letterSpacing: -0.4, color: Color(0xFFE8EFF0)),
        displaySmall:   TextStyle(fontWeight: FontWeight.w600, fontSize: 24, color: Color(0xFFE8EFF0)),
        headlineLarge:  TextStyle(fontWeight: FontWeight.w700, fontSize: 22, color: Color(0xFFE8EFF0)),
        headlineMedium: TextStyle(fontWeight: FontWeight.w600, fontSize: 18, color: Color(0xFFE8EFF0)),
        headlineSmall:  TextStyle(fontWeight: FontWeight.w600, fontSize: 16, color: Color(0xFFE8EFF0)),
        ...
        bodyMedium:     TextStyle(fontWeight: FontWeight.w400, fontSize: 13, height: 1.6, color: Color(0xFFD0D8DC)),
        bodySmall:      TextStyle(fontWeight: FontWeight.w300, fontSize: 11.5, color: Color(0xFFB0B8BC)),
        labelLarge:     TextStyle(fontWeight: FontWeight.w700, fontSize: 12.5, letterSpacing: 0.3, color: Color(0xFFE8EFF0)),
        labelMedium:    TextStyle(fontWeight: FontWeight.w600, fontSize: 11,   letterSpacing: 0.2, color: Color(0xFFD0D8DC)),
        labelSmall:     TextStyle(fontWeight: FontWeight.w600, fontSize: 9.5,  letterSpacing: 0.5, color: Color(0xFFB0B8BC)),
      ),
    ),
    appBarTheme: AppBarTheme(
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(AppDimensions.radiusMd),
        borderSide:
            const BorderSide(color: Color(0xFF3A4E42), width: 1.5),
      ),
      enabledBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(AppDimensions.radiusMd),
        borderSide:
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(AppDimensions.radiusMd),
        borderSide:
            BorderSide(color: AppColors.sageLt.withAlpha(153), width: 1.5),
      ),
      errorBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(AppDimensions.radiusMd),
      ...
      hintStyle: const TextStyle(
          ...
          fontSize: 13.5),
      errorStyle:
          const TextStyle(color: AppColors.terrLt, fontSize: 11),
      contentPadding: AppDimensions.fieldContentPad,
    ),
    bottomNavigationBarTheme: const BottomNavigationBarThemeData(
    ...
    chipTheme: ChipThemeData(
      ...
      side: BorderSide(color: AppColors.sageLt.withAlpha(70)),
      shape:
          RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 6),
    ),
    ...
    switchTheme: SwitchThemeData(
      ...
      trackColor: WidgetStateProperty.resolveWith((s) =>
          s.contains(WidgetState.selected)
              ? AppColors.sageLt.withAlpha(120)
    ...
    snackBarTheme: SnackBarThemeData(
      backgroundColor: AppColors.darkSurface,
      contentTextStyle: GoogleFonts.poppins(
          color: const Color(0xFFE8EFF0), fontSize: 13),
      actionTextColor: AppColors.sageLt,
      shape:
          RoundedRectangleBorder(borderRadius: BorderRadius.circular(14)),
      behavior: SnackBarBehavior.floating,
